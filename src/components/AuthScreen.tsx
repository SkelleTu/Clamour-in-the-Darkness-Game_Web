...
import { Eye, EyeOff, ExternalLink, Loader2, LockKeyhole, LogIn, UserPlus } from 'lucide-react';
...
export function AuthScreen({ onAuthenticated }: Props) {
  ...
  const openDashboard = () => window.open('/us/', '_blank', 'noopener,noreferrer');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#050507] text-white pointer-events-auto">
      ...
      <button
        ...
        className="fixed right-5 top-5 z-20 flex items-center gap-2 rounded-full border border-white/10 bg-black/35 px-3 py-2 text-[10px] font-mono uppercase tracking-widest text-white/45 backdrop-blur-md transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white/80"
      >
