export const RULES = {
  ...
  movement: {
    ...
    controllerRadius: 0.32, controllerHeight: 1.8, stepOffset: 0.22, skinWidth: 0.04,
    carrySpeedMultiplierMin: 0.1, carrySpeedMultiplierMax: 1.0,
  },
  stumble: {
    enabled: true, minimumObstacleHeight: 0.16, maxObstacleHeight: 0.62,
    cooldownSeconds: 1.25, durationSeconds: 0.45, speedThreshold: 2.4,
    speedLoss: 0.55, verticalImpulse: 1.5,
  },
  camera: {
    eyeHeight: 1.62, lookSensitivity: 0.075, minPitch: -78, maxPitch: 82,
    walkBobFrequency: 7, sprintBobFrequency: 10.5,
  ...
  persistence: { autosaveSeconds: 3, restoreLastPosition: true, initialSpawnFromHome: true },
  network: { playerDirectoryLimit: 64, eventLimit: 100, heartbeatMs: 500 },
} as const;
